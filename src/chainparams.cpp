...
public:
	...
	// Build the genesis block. Note that the output of the genesis coinbase cannot
        ...
        const char* pszTimestamp = "Roadcoin, A Currency for a Digital Age";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        vSeeds.push_back(CDNSSeedData("roadcoin.co seed #1", "roadcoin.co"));        
		vSeeds.push_back(CDNSSeedData("roadcoin.co seed #2", "game.roadcoin.co"));
		vSeeds.push_back(CDNSSeedData("roadcoin.co seed #3", "dev.roadcoin.co"));
