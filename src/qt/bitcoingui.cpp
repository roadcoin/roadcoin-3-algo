    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Roadcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Roadcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and roadcoin: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Roadcoin"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Roadcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Roadcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Roadcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Roadcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Roadcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a roadcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Roadcoin help message to get a list with possible Roadcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Roadcoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Roadcoin client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Roadcoin network", "", count));
}
...
{
    QString strTitle = tr("Roadcoin"); // default title
