...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"roadcoinaddress\"\n"
            "\nReturn information about the given roadcoin address.\n"
            "\nArguments:\n"
            "1. \"roadcoinaddress\"     (string, required) The roadcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,            (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"roadcoinaddress\", (string) The roadcoin address validated\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"roadcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"roadcoinaddress\"  (string, required) The roadcoin address to use for the signature.\n"
