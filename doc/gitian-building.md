...
*Setup instructions for a gitian build of Roadcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Roadcoin
...
- [Building Roadcoin](#building-roadcoin)
...
Clone the git repositories for roadcoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/roadcoin/roadcoin
```
...
In [doc/release-process.md](release-process.md) in the roadcoin repository under 'Fetch and build inputs'.
...
To build Roadcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the roadcoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/roadcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/bitcoin/roadcoin
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/roadcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/roadcoin-build.assert
```
...
[roadcoin/gitian.sigs](https://github.com/bitcoin/gitian.sigs/) repository, or
